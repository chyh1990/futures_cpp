...
protected:
  static inline size_t goodMallocSize(size_t l) { return l; }
  static inline void *checkedMalloc(size_t l) {
    void *p = malloc(l);
  ...
  static inline void* smartRealloc(void* p,
